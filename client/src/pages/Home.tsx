...
const Home = () => {
    return (
        <section className="px-5 py-10 bg-gray-100 text-gray-800 h-full">
            <div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
                <div className="flex flex-col justify-between col-span-12 py-2 space-y-8 md:space-y-16 md:col-span-3">
                    <div className="flex flex-col space-y-8 md:space-y-12">
                        <div className="flex flex-col space-y-2">
                            <h3 className="flex items-center space-x-2 text-gray-600">
                                <span className="flex-shrink-0 w-2 h-2 uppercase rounded-full bg-indigo-600"></span>
                            ...
                            >
                                Donec sed elit quis odio mollis dignissim eget
                                et nulla.
                            </a>
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <a
                                ...
                                className="font-serif hover:underline"
                            >
                                Ut fermentum nunc quis ipsum laoreet
                                condimentum.
                            </a>
                            <p className="text-xs dark:text-gray-600">
                                2 hours ago by
                    ...
                    <div className="flex flex-col w-full space-y-2">
                        <div className="flex w-full h-1 bg-opacity-10 bg-indigo-600">
                        ...
                        >
                            ...
                            <svg
                                ...
                                className="w-4 strokeCurrent text-indigo-600"
                            >
                ...
                >
                    <span className="absolute px-1 pb-2 text-xs font-bold uppercase border-b-2 left-6 top-6 text-gray-800 border-indigo-600">
                        paris, france
                    </span>
                    <a className="flex flex-col items-center justify-end p-6 text-center sm:p-8 group dark:via- flex-grow-1 bg-gradient-to-b">
                        <span className="flex items-center mb-4 space-x-2 text-indigo-600">
                            <span className="relative flex-shrink-0 w-2 h-2 rounded-full bg-indigo-600">
                                <span className="absolute flex-shrink-0 w-3 h-3 rounded-full -left-1 -top-1 animate-ping bg-indigo-600"></span>
                            </span>
                        ...
                        >
                            Morbi mattis justo est, ac consectetur dui eleifend
                            vitae. Donec venenatis?
                        </h1>
                    </a>
                </div>
                <div className="hidden py-2 xl:col-span-3 lg:col-span-4 md:hidden lg:block">
                    <div className="mb-8 space-x-5 border-b-2 border-opacity-10 dark:border-indigo-600">
                        <button
                            type="button"
                            className="pb-5 text-xs font-bold uppercase border-b-2 dark:border-indigo-600"
                        >
                            Latest
                        </button>
                        <button
